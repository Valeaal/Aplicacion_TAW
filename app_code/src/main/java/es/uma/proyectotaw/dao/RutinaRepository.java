...
public interface RutinaRepository extends JpaRepository<Rutina, Integer> {
    ...
    @Query("select r from Rutina r where r.nombre like concat('%',:nombre,'%') and size(r.entrenamientos) = :num and r.tipoRutina.id = :tipo and r.entrenador =:creador and r.fechaCreacion>=:fecha")
    public List<Rutina> findByNombreEntrenosAndCreador(@Param("nombre") String nombre,@Param("num")Integer num,@Param("creador")Usuario usuario,@Param("tipo") Integer tipo, @Param("fecha")LocalDate fecha);

    @Query("select r from Rutina r where r.nombre like concat('%',:nombre,'%') and r.tipoRutina.id = :tipo and r.entrenador =:creador and r.fechaCreacion>=:fecha")
    public List<Rutina> findByNombreAndCreador(@Param("nombre") String nombre, @Param("creador")Usuario usuario, @Param("tipo") Integer tipo, @Param("fecha")LocalDate fecha);
