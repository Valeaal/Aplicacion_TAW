...
<% DietaDTO d = (DietaDTO) request.getAttribute("dieta"); %>
<html>
<head>
    <title>Nueva Dieta - 5 Ingestas</title>
...
<h2 class="mb-4">Nueva Dieta - 5 Ingestas</h2>
<form:form method="post" modelAttribute="DietaCrearForm" action="/dietista/generar5">
    ...
    <th>Ingesta 4</th>
    <td>
    <form:select path="ingesta4Dia1">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta4Dia2">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta4Dia3">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta4Dia4">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta4Dia5">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    ...
    <th>Ingesta 5</th>
    <td>
    <form:select path="ingesta5Dia1">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta5Dia2">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta5Dia3">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta5Dia4">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
    <td>
    <form:select path="ingesta5Dia5">
        <form:option value="">Selecciona</form:option>
        <form:options items="${comidas}" itemLabel="nombre" itemValue="id"/>
    </form:select>
    </td>
